 ...
 * @author Asullom
 */
public class LotePanel extends javax.swing.JPanel {

    LoteTableModel LoteTableModel = new LoteTableModel();
    ...
    private void paintTable(LoteTableModel tableModel) {
        this.LoteTableModel = tableModel;
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            Lote filax = (Lote) LoteTableModel.getRow(table.getSelectedRow());
            Lote d = LoteData.getByPId(filax.getId());
            productNameField.setText(d.getNumero());
            productCodeField.setText(d.getDireccion());
            priceProductField.setText(d.getValor_venta()+"");
            quantityProductField.setText(d.getFecha_venta()+"");
            infoadicProductField.setText(d.getDate_created().toString());
    ...
    private void initComponents() {
        ...
        dateSaleLoteChooser = new com.toedter.calendar.JDateChooser();
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(dateSaleLoteChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (this.productNameField.getText().equals("")) {
            ...
            if (table.getSelectedRow() != -1) {// ha seleccionado, update
                try {
                    ...
                    if (s.getId() > 0) {
                        int returnId = LoteData.update(s);
                        if (returnId != 0) {
                            paintTable(new LoteTableModel());
                            resetForm();
                ...
                try {
                    int returnId = LoteData.create(s);
                    if (returnId != 0) {
                        paintTable(new LoteTableModel());
        ...
        if (table.getSelectedRow() != -1) {
            try {
                ...
                if (opc == JOptionPane.OK_OPTION) {
                    ...
                    int opcion = LoteData.delete(fila.getId());
                    if (opcion != 0) {
    ...
    private void buscarFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarFieldKeyReleased
        // TODO add your handling code here:
        LoteTableModel tableModel = new LoteTableModel(buscarField.getText());
    ...
    private void theButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_theButton4ActionPerformed
        ...
        try {
            ...
            ErrorLogger.log(Level.SEVERE, LotePanel.class.getName() + ".ExportarExcel", ex);
    ...
    private com.toedter.calendar.JDateChooser dateSaleLoteChooser;
