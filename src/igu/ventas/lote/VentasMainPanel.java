...
import igu.compras.productos.ProductosPanel;
...
public class VentasMainPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        LoteButton = new igu.utils.buttons.TheButton();
        comprasButton = new igu.utils.buttons.TheButton();
        workPanel = new javax.swing.JPanel();

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        LoteButton.setBackground(new java.awt.Color(239, 238, 244));
        LoteButton.setForeground(new java.awt.Color(128, 128, 131));
        LoteButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/igu/imgs/icons/user_blue_32.png"))); // NOI18N
        LoteButton.setText("LOTE");
        LoteButton.setColorHover(new java.awt.Color(204, 204, 204));
        LoteButton.setColorNormal(new java.awt.Color(239, 238, 244));
        LoteButton.setColorPressed(new java.awt.Color(204, 204, 204));
        LoteButton.setColorTextHover(new java.awt.Color(128, 128, 131));
        LoteButton.setColorTextNormal(new java.awt.Color(128, 128, 131));
        LoteButton.setColorTextPressed(new java.awt.Color(128, 128, 131));
        LoteButton.setFocusable(false);
        LoteButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                LoteButtonMousePressed(evt);
            }
        });
        LoteButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                LoteButtonActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(LoteButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(LoteButton, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
    ...
    private void comprasButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comprasButtonActionPerformed
        ...
        if (this.comprasButton.isSelected()) {
            ...
            this.LoteButton.setColorNormal(new Color(239, 238, 244));
    ...
    private void LoteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoteButtonActionPerformed
        // TODO add your handling code here:
        new ChangePanel(workPanel, new LotePanel());
        ...
        if (this.LoteButton.isSelected()) {
            this.LoteButton.setColorNormal(new Color(204, 204, 204));
    ...
    }//GEN-LAST:event_LoteButtonActionPerformed

    private void LoteButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoteButtonMousePressed
        // TODO add your handling code here:
         this.LoteButton.setSelected(true);
        this.comprasButton.setSelected(false);
        
    }//GEN-LAST:event_LoteButtonMousePressed
    ...
    private void comprasButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_comprasButtonMousePressed
        ...
        this.LoteButton.setSelected(false);
        
    }//GEN-LAST:event_comprasButtonMousePressed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private igu.utils.buttons.TheButton LoteButton;
